PDDL Project: Robot Chef Task

Overview
--------
This project involves the implementation of a robot sushi restaurant problem using Planning Domain Definition Language (PDDL). The PDDL files are designed to work with planners that support numeric fluents and types. We have used Metric-FF as our planner for testing and execution.
...
- domain2.pddl: Contains the extended domain definition, including types, predicates, and actions.
